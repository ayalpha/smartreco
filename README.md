...
Built by **AY Systum** for the **THE ZEROPS CHALLENGE**
...
```bash
git clone https://github.com/ayalpha/smartreco.git
cd smartreco
...
**Built for the THE ZEROPS CHALLENGE**
