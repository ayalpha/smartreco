...
from app.routers import admin, assistant, auth, cart, events, paths, products, recommendations

__all__ = ["admin", "assistant", "auth", "cart", "events", "paths", "products", "recommendations"]
